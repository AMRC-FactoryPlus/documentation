...
ConfigDB, and authentication against the Git server is integrated with
...
Git repositories are managed through the ConfigDB, by creating entries
...
object should be created under the 'Git repository' ConfigDB class.
