...
As per the [Component Specification](/docs/framework-components/specification), the Authorisation component provides a MQTT/Sparkplug interface and a HTTP interface. The Authorisation component uses `cab2642a-f7d9-42e5-8845-8f35affe1fd4` as the `Service_UUID`.
