...
export const ACS = () => (
    <div className="relative overflow-hidden w-full">
        <div className="relative flex items-center justify-center">
            <div className="m-1 flex-1 max-w-7xl grid gap-16 pt-4 px-0">
                <div className={'mb-8 2xl:mb-0'}>
                    <div className="flex items-center justify-start mb-2 gap-2">
                        <div className="text-xl text-gray-700 font-semibold mr-2">AMRC Connectivity Stack</div>
                        <div className="invisible sm:visible bg-brand px-2 py-1 text-xs uppercase tracking-wide text-white font-bold">NEW</div>
                        <div className="invisible sm:visible bg-brand-70 px-2 py-1 text-xs uppercase whitespace-nowrap tracking-wide text-white font-bold flex items-center justify-center gap-1">
                            <FontAwesomeIcon icon={faGithub}/>
                            <div>OPEN SOURCE</div>
                        </div>
                    </div>
                    <div className="text-gray-400 h-10 mb-6">
                        The AMRC Connectivity Stack is an open-source reference implementation of the Factory+ Framework
                    </div>
